...
public class BlockEntityCratePatch
{
        ...
        ref int ___labelColor)
    {
        ...
        // Global.Api.Logger.Debug("BlockEntityCratePatch.BlockEntityCrate_OnBlockInteractStart_Prefix");
        BlockEntityCratePatch original = new BlockEntityCratePatch(
            __instance,
            ref __result,
            ref ___inventory,
            ref ___labelStack,
    ...
    public BlockEntityCratePatch(BlockEntityCrate __instance, ref bool __result, ref InventoryGeneric ___inventory, ref ItemStack ___labelStack, ref MeshData ___labelMesh, ref int ___labelColor)
    {
        orig = __instance;
